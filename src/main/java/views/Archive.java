...
public class Archive extends Base {
    CustomerServiceImpl customerServiceImplDone=new CustomerServiceImpl(4);
    public Archive() {
        initComponents();
        lblName.setText("Dear. " + UserImpl.name);
        tblArchive.setModel(customerServiceImplDone.serviceCustomerTable(null));
    }
    ...
    private void txtCustomerSearchKeyReleased(KeyEvent e) {
        ...
        tblArchive.setModel(customerServiceImplDone.serviceCustomerTable(txtSearch));
    }
            ...
            contentPaneLayout.createParallelGroup()
                .addGroup(contentPaneLayout.createSequentialGroup()
                    ...
                    .addGroup(contentPaneLayout.createParallelGroup()
                        ...
                        .addComponent(txtCustomerSearch, GroupLayout.DEFAULT_SIZE, 586, Short.MAX_VALUE)
                        .addGroup(contentPaneLayout.createSequentialGroup()
                            .addComponent(lblService, GroupLayout.PREFERRED_SIZE, 350, GroupLayout.PREFERRED_SIZE)
                            .addGap(18, 18, 18)
                            .addComponent(lblName, GroupLayout.DEFAULT_SIZE, 218, Short.MAX_VALUE)))
                    .addContainerGap())
        );
